 ...
 * @author		JoomlaUX!
 * @package		Joomla.Site
 * @subpackage	mod_jux_real_estate_ouratate
...
class modJUXRealEstateOuragents {
	
	protected $prefix = '#jux_real_estate_ouragents';
	...
	protected function _renderItemStyle(&$params){
		...
		$itemStype .= ' '.$this->prefix.'  #owl-demo .ouragents-body {'. $jux_margin. ' }';
	...
	public static function process(&$params,$filename,$prefix=''){
		$css = new modJUXRealEstateOuragents($prefix);
