        ...
        (function(){
            djConfig = {
              modulePaths: {
                "dojo": "/smartsliderdemo/plugins/system/dojoloader/dojo/1.6.1/dojo",
                "dijit": "/smartsliderdemo/plugins/system/dojoloader/dojo/1.6.1/dijit",
                "dojox": "/smartsliderdemo/plugins/system/dojoloader/dojo/1.6.1/dojox"
              }
...
dojo.declare("NextendSmartSliderResizeImage", null, {
    ...
    resize: function() {
        ...
        while(p != null && !dojo.hasClass(p, 'sslide') ){
            p = p.parentNode;
        }
        var style = dojo.attr(p,'style');
        dojo.style(p, {
          visibility: 'hidden',
          display : 'block'
        });
...
dojo.declare("OfflajnSliderPhotoExperimental", NextendSmartSliderResponsive, {
    constructor: function(args) {
