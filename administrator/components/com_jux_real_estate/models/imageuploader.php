...
class JUX_Real_EstateModelImageuploader extends JModelLegacy
{
	...
	function __construct()
	{
		...
		$limit		= $app->getUserStateFromRequest( $option.'imageuploader'.$task.'limit', 'limit', $app->getCfg('list_limit'), 'int');
		$limitstart = $app->getUserStateFromRequest( $option.'imageuploader'.$task.'limitstart', 'limitstart', 0, 'int' );
	...
	function getList()
	{
		...
		$basePath = JPATH_SITE.DS.'images'.DS.'jux_real_estate'.DS.$folder;
