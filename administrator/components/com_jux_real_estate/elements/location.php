...
class JFormFieldLocation extends JFormField {
	...
	$html .= '<div class="button2-left"><div class="blank"><a class="modal" title="' . JText::_('COM_JUX_REAL_ESTATE_SELECT_LOCATION') . '"  href="' . $link . '" rel="{handler: \'iframe\', size: {x: 850, y: 375}}">' . JText::_('COM_JUX_REAL_ESTATE_SELECT_LOCATION') . '</a></div></div>' . "\n";
