...
$canOrder = $user->authorise('core.edit.country', 'com_jux_real_estate');
...
<form action="<?php echo JRoute::_('index.php?option=com_jux_real_estate&view=countries'); ?>" method="post" name="adminForm"
      id="adminForm">
    <!-- code 3.0 -->
		...
		<div class="btn-group pull-left hidden-phone">
			...
			<th width="1%" style="min-width:55px" class="nowrap center">
			    ...
			    <?php echo JHTML::_('grid.sort', 'COM_JUX_REAL_ESTATE_NAME', 'a.name', $listDirn, $listOrder); ?>
                        ...
                        <th style="text-align: left;">
			    <?php echo JHTML::_('grid.sort', 'COM_JUX_REAL_ESTATE_CODE', 'a.code', $listDirn, $listOrder); ?>
                        </th>
			...
			foreach ($this->items as $i => $item) {
			    ...
			    $canEdit = $user->authorise('core.edit', 'com_jux_real_estate.country.' . $item->id);
			    $canChange = $user->authorise('core.edit.country', 'com_jux_real_estate.country.' . $item->id);
			    ?>
				...
				<td>
				    <?php if ($canEdit) : ?>
	    			    <a href="<?php echo JRoute::_('index.php?option=com_jux_real_estate&task=country.edit&id=' . (int) $item->id); ?>">
