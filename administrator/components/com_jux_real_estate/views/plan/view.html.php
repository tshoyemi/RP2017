 ...
 * @since		3.0
 */
class JUX_Real_EstateViewPlan extends JViewLegacy {
	...
	// set page title
	$title = JText::_('COM_JUX_REAL_ESTATE_PLAN_MANAGER_' . ($checkedOut ? 'VIEW' : ($isNew ? 'ADD' : 'EDIT')));
	$document = JFactory::getDocument();
	$document->setTitle($title);
	JToolBarHelper::title($title, 'plans.png');
